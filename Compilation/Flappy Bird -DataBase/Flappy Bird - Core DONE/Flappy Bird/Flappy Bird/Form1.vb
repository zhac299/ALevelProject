...
#Region "Variables"
    ...
    Dim Score As Integer 'Holds the Players Score
...
#End Region
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Randomize() 'Calls the Random Function
        ...
        If UserInput = "Yes" Then 'If Random Mode is Active then the following code is ran
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        Else
            ...
            For i = 0 To 1 'This For Loop allows the Pipes to move to the Left Hand side of the Screen
                ...
                If (pbBird.Bounds.IntersectsWith(Pipe(i).Bounds)) Or pbBird.Bounds.IntersectsWith(TopPipe(i).Bounds) Then 'Code makes it so if pbBird touches any Pipe the Game Ends
                    Timer1.Stop() 'The Timer, Timer1, is stopped
                    Form2.Score2 = Score 'Score is transferred from this form to form2
                    MessageBox.Show("Your Score is " & Score) 'MessageBox Appears which tells the user their score
                    Form2.Show() 'Form2 Opens
                    Me.Hide() 'This Form Closes
                End If
            Next

            If (pbBird.Bounds.IntersectsWith(pbTopWall.Bounds)) Then 'If the bird Collides with the top wall then the following code runs
                Timer1.Stop() 'The Timer, Timer1, is stopped
                Form2.Score2 = Score 'Score is transferred from this form to form2
                MessageBox.Show("Your Score is " & Score) 'MessageBox Appears which tells the user their score
                Form2.Show() 'Form2 Opens
                Me.Hide() 'This Form Closes
            ElseIf (pbBird.Bounds.IntersectsWith(pbBottomWall.Bounds)) Then 'If the Bird collides with the bottom wall then the following code runs
                Timer1.Stop() 'The Timer, Timer1, is stopped
                Form2.Score2 = Score 'Score is transferred from this form to form2
                MessageBox.Show("Your Score is " & Score) 'MessageBox Appears which tells the user their score
                Form2.Show() 'Form2 Opens
            ...
            lblScore.Text = (Score) 'Displayes the Users Score to the User
        End If
    End Sub
    ...
    Private Sub CreatePipes(ByVal Number As Integer)
        For i = 0 To Number
            ...
            pbTemp.BackColor = Color.Green 'Makes Pipe Green
            pbTemp.Top = r.Next(70, 350)  'Generates a Number Between the Range 70-350
    ...
    Private Sub CreateTopPipes(ByVal Number As Integer)
        For i = 0 To Number
            ...
            pbTemp.BorderStyle = BorderStyle.FixedSingle
            pbTemp.BackColor = Color.Green 'Makes Pipe Green
            pbTemp.Top = Pipe(i).Top - GapBetweenPipes 'Creates a consistent gap between each pipe
            pbTemp.Left = i * 200 + 300 'Uses to Calculate the Number of Pipes as well as their distance from pbBird similiar to a function f(x) on a graph
            TopPipe(i) = pbTemp
